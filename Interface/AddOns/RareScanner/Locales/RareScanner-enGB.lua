...
if AL then
	...
	AL["COLLECTION_FILTERS_PROFILE_BACKUP_DESC"] = "When enabled the filters will be applied to a new profile copied from your current profile. This will give you the option to switch back to your current profile if you aren't happy with the results. It is recomended to enable this option if you are going to filter entities by missing appearances and you are using the 'Default' profile which is shared between all your characters."
	AL["COLLECTION_FILTERS_TEXT1"] = "Choose the types of collections that you are interesed in and hit the button [%s]."
