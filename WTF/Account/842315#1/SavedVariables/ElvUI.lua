	...
	["profiles"] = {
		...
		["Derptarogar - Draenor"] = {
			...
			["movers"] = {
				...
				["BossButton"] = "BOTTOM,ElvUIParent,BOTTOM,-149,299",
				["LootFrameMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,418,-186",
				["ZoneAbility"] = "BOTTOM,ElvUIParent,BOTTOM,149,299",
				...
				["ObjectiveFrameMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-104,-334",
